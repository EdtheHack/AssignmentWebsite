	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			if ($product->getPercentage() == 0){
				echo "<h5 class=\"pull-right\"><strong> &pound;".$product->getPrice()."</strong></h5>";
			} else {
				...
				echo "<h5 class=\"pull-right\"><strong> Our Price: &pound;".$salePrice."</strong> RRP: <strike>&pound;".$product->getPrice() ."</strike><br></h5>";
			}  
