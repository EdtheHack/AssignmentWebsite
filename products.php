...
<div class="container">
  ...
  <div class="well">
    <div class="row">
      <h3>Our Products<?php echo $lol ?></h3>
      <?php
				$rows = getAllProducts();
			...
			?>
      <div class="thumbnail"> <a href="viewProduct.php?<?php echo $product->getId(); ?>"> <img src="img/<?php echo $product->getImg(); ?>" alt="Image of one of our products" height="150" width="auto"> </a>
        <div class="caption">
