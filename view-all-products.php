  ...
  <div class="well">
    <div class="row">
      ...
      <?php
			...
			?>
      <div class="thumbnail"> <a href="viewProduct.php?<?php echo $product->getId(); ?>"> <img src="img/<?php echo $product->getImg(); ?>" alt="Image of one of our products" height="150" width="150"> </a>
        <div class="caption">
